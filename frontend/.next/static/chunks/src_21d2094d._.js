...
"[project]/src/services/cryptoService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsencrypt$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/jsencrypt/lib/index.js [app-client] (ecmascript) <module evaluation>");
...
class CryptoService {
    ...
    static _generateRSAKeyPairFallback() {
        try {
            ...
            const jsencrypt = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsencrypt$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]({
...
"[project]/src/services/keyExchangeService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class KeyExchangeService {
   ...
   */ async initializeKeys(githubUsername, githubToken) {
        ...
        try {
            const keyStorageService = (await __turbopack_context__.r("[project]/src/services/keyStorageService.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
            ...
            const CryptoService = (await __turbopack_context__.r("[project]/src/services/cryptoService.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
            ...
            if (githubToken) {
                const githubKeyService = (await __turbopack_context__.r("[project]/src/services/gitHubService.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
...
"[project]/src/services/keyStorageService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/encryptionService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyStorageService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/keyStorageService.js [app-client] (ecmascript)");
;
;
;
...
class EncryptionService {
   ...
   */ async decryptMessage(encryptedData, senderUserId) {
        ...
        try {
            ...
            const myPublicKey = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getMyPublicKey();
            const myKeyVersion = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getMyKeyVersion();
            ...
            const decryptedMessage = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cryptoService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].decryptWithAES(encryptedData.content, encryptedData.iv, aesKey);
   ...
   */ async decryptMessageWithoutSignature(encryptedData) {
        try {
            ...
            // Decrypt AES key with our private key
            const myPrivateKey = await this._getMyPrivateKey();
            const aesKey = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cryptoService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].decryptWithRSA(encryptedData.encrypted_aes_key, myPrivateKey);
            // Decrypt message content with AES key
            const decryptedMessage = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cryptoService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].decryptWithAES(encryptedData.content, encryptedData.iv, aesKey);
            this.lastError = null;
            return decryptedMessage;
   ...
   */ isEncryptionAvailable() {
        return this.isInitialized && this.currentUserId && this.currentToken && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getMyPrivateKey() !== null;
    }
    /**
   * Get current encryption status
   * @returns {Object} Encryption status information
   */ getEncryptionStatus() {
        const hasPrivateKey = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getMyPrivateKey() !== null;
        const hasPublicKey = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getMyPublicKey() !== null;
   ...
   */ async clearEncryption() {
        try {
            if (this.currentUserId) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyStorageService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].clearPrivateKey(this.currentUserId);
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].clearCache();
            this.isInitialized = false;
            this.currentUserId = null;
            this.currentToken = null;
            this.lastError = null;
   ...
   */ async _performInitialization(userId, token) {
        ...
        try {
            ...
            let privateKey = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyStorageService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getPrivateKey(userId);
            let publicKey = null;
            if (privateKey) {
                console.log('INIT: Found existing private key, validating...');
                const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyStorageService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].validateStoredKey(userId);
                if (!isValid) {
            ...
            if (!privateKey) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyStorageService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].storePrivateKey(userId, privateKey);
   ...
   */ async _getRecipientPublicKey(recipientGithubUsername) {
        ...
        try {
            ...
            const pemKey = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getUserPublicKey(recipientGithubUsername);
   ...
   */ async _getMyPrivateKey() {
        const privateKey = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$keyExchangeService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getMyPrivateKey();
        if (!privateKey) {
   ...
   */ async _verifyMessageSignature(message, signature, senderUserId) {
        ...
        try {
            ...
            const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cryptoService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].verifyRSASignature(message, signature, senderPublicKey);
            if (!isValid) {
   ...
   */ async _signWithPrivateKey(data, privateKeyPem) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cryptoService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].signWithRSA(data, privateKeyPem);
    }
    /**
   * Verify signature with RSA public key
   */ async _verifyWithPublicKey(data, signature, publicKeyPem) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$cryptoService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].verifyRSASignature(data, signature, publicKeyPem);
    }
}
// Export singleton instance
...
"[project]/src/services/userPreferencesService.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userPreferencesService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/userPreferencesService.js [app-client] (ecmascript)");
;
...
const AuthProvider = ({ children })=>{
    ...
    const [keyInitialization, setKeyInitialization] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    const initializeEncryptionKeys = async (user)=>{
        try {
            ...
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$encryptionService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].initialize(user.uid, user.accessToken);
            if (success) {
                setKeyInitialization((prev)=>({
                        ...prev,
                        progress: 100,
    ...
    const logout = async (options = {})=>{
        try {
            ...
            const shouldClearKeys = options.clearKeys !== undefined ? options.clearKeys : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userPreferencesService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].shouldClearKeysOnLogout();
            // Clear encryption keys based on user preference
            if (currentUser && shouldClearKeys) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$encryptionService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].clearKeys();
    ...
    const updateUserPreferences = (preferences)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userPreferencesService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].updatePreferences(preferences);
    };
    const getUserPreferences = ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userPreferencesService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getPreferences();
    };
...
_s1(AuthProvider, "Adox22IF/Zfv2WSIjnzHOhfS008=");
_c = AuthProvider;
var _c;
...
"[project]/src/components/ErrorBoundary.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_21d2094d._.js.map